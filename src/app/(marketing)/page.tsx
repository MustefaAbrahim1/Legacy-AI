  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="w-full bg-accent/50">
        <div className="container px-4 md:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-4rem)] py-20 lg:py-0">
      ...
      <section className="w-full py-24 bg-accent/50">
        <div className="container px-4 md:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
